...
void Shader::CompileShader(const char* vertexCode, const char* fragmentCode)
{
	...
	uniformIlluminationType = glGetUniformLocation(shaderID, "material.illuminationType");

	//cook Torrance specific values
...
GLuint Shader::GetIlluminationTypeLocation()
{
	return uniformIlluminationType;
}
